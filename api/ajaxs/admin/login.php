...
//         die(json_encode([
//             'status'    => 'verify',
//             'url'       => base_url('admin/verify-otp-mail/'.$otp_email_token),
...
//         die(json_encode([
//             'status'    => 'verify',
//             'url'       => base_url('admin/verify/'.$token_2fa),
...
//     ]);
//     $new_token = md5(random('0123456789qwertyuiopasdgjklzxcvbnm', 12).uniqid());
//     $CMSNT->update("users", [
//         'login_attempts'    => 0,
//         'ip'            => myip(),
//         'time_request'  => time(),
