                            ...
                            <table id="datatable1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                <li>Đang bán:  <b style="color: green;"><?=format_cash($CMSNT->get_row("SELECT COUNT(id)  FROM `accounts` WHERE `product_id` = '".$row['id']."' AND `buyer` IS NULL  ")['COUNT(id)']);?></b> <a href="<?=base_url('admin/account-view/'.$row['id']);?>">Xem</a></li>
                                                <li>Đã bán:  <b style="color:blue;"><?=format_cash($CMSNT->get_row("SELECT COUNT(id)  FROM `accounts` WHERE `product_id` = '".$row['id']."' AND `buyer` IS NOT NULL ")['COUNT(id)']);?></b> <a href="<?=base_url('admin/account-sold/'.$row['id']);?>">Xem</a></li>
