            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- ===== GACHA TÚI MÙ ===== -->
                        <li class="nav-item <?=menuopen_sidebar(['box-manager','box-rates','box-import','box-history']);?>">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-gift" style="color:#FFD700;"></i>
                                <p>
                                    🎁 Túi Mù Gacha
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/box-manager');?>"
                                        class="nav-link <?=active_sidebar(['box-manager']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Quản Lý Túi Mù</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/box-rates');?>"
                                        class="nav-link <?=active_sidebar(['box-rates']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cài Đặt Tỉ Lệ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/box-import');?>"
                                        class="nav-link <?=active_sidebar(['box-import']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Import Kho Hàng</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/box-history');?>"
                                        class="nav-link <?=active_sidebar(['box-history']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Lịch Sử Mở Túi</p>
                                    </a>
                                </li>
