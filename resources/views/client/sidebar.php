            ...
            <div class="data-scrollbar" data-scroll="1">
                <nav class="iq-sidebar-menu">
                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                        ...
                        <!-- ===== GACHA TÚI MÙ MENU ===== -->
                        <li class="<?=active_sidebar_client(['blind-boxes','unbox']);?> sidebar-layout">
                            <a href="<?=base_url('client/blind-boxes');?>" class="svg-icon ">
                                <i class="fas fa-gift" style="color:#FFD700;"></i>
                                <span class="ml-2" style="font-weight:700;color:#FFD700;">🎁 Cửa Hàng Túi Mù</span>
                            </a>
                        </li>
                        <li class="<?=active_sidebar_client(['inventory']);?> sidebar-layout">
                            <a href="<?=base_url('client/inventory');?>" class="svg-icon ">
                                <i class="fas fa-archive" style="color:#CE93D8;"></i>
                                <span class="ml-2" style="font-weight:600;color:#CE93D8;">🎒 Kho Đồ Của Tôi</span>
                            </a>
                        </li>
                        <!-- ===== END GACHA MENU ===== -->
                        ...
                        <?php endif?>
                        <?php /* HIDDEN – Dịch Vụ Tăng Like (SMM cũ – đã pivot sang Gacha)
